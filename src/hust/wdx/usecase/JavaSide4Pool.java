...
import hust.wdx.thread.JedisThreadSafeUtil;

public class JavaSide4Pool {

	static JedisThreadSafeUtil util = JedisThreadSafeUtil.getInstance();
	static Long start;
	...
	public static void main2(String[] args) {
		...
		for (int i = 0; i < 100; i++) {
			threads[i] = new Thread(new Task4Pool());
		}
...
class Task4Pool implements Runnable {
...
//			System.out.print(Thread.currentThread().getName() + " ");
		...
		Long end = System.currentTimeMillis();
		System.out.println(end - JavaSide4Pool.start);
	}
}
